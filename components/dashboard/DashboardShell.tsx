    ...
    <>
      ...
      <div className="px-4 mb-4">
        <div className="flex items-center gap-3 p-3 bg-surface-container rounded-xl border border-outline-variant">
          ...
          <div>
            <p className="text-sm font-bold text-on-surface">{displayName.split(" ")[0]}</p>
      ...
      <div className="p-4 mt-auto border-t border-outline-variant">
        <LogoutButton className="w-full flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-error transition-colors disabled:opacity-50">
